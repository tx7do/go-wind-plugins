...
func defaultResolver(_ context.Context, entries []*api.ServiceEntry) []*wind.Instance {
	services := make([]*wind.Instance, 0, len(entries))
...
type ServiceResolver func(ctx context.Context, entries []*api.ServiceEntry) []*wind.Instance

// Service get services from consul
func (c *Client) Service(ctx context.Context, service string, index uint64, passingOnly bool) ([]*wind.Instance, uint64, error) {
...
func (c *Client) multiDCService(ctx context.Context, service string, index uint64, passingOnly bool) ([]*wind.Instance, uint64, error) {
	opts := &api.QueryOptions{
		WaitIndex: index,
		WaitTime:  time.Second * 55,
	}
...
func (c *Client) Register(_ context.Context, svc *wind.Instance, enableHealthCheck bool) error {
