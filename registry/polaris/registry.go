...
func (r *Registry) Register(_ context.Context, serviceInstance *wind.Instance) error {
...
type Watcher struct {
	...
	ServiceInstances []*wind.Instance
}
...
func instancesToServiceInstances(instances []model.Instance) []*wind.Instance {
	serviceInstances := make([]*wind.Instance, 0, len(instances))
...
func instanceToServiceInstance(instance model.Instance) *wind.Instance {
	metadata := instance.GetMetadata()
	// Usually, it won't fail in wind if register correctly
	kind := ""
