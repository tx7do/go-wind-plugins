...
// wind-service-id: define the ID of the service
// wind-service-app: define the name of the service
// wind-service-version: define the version of the service
// wind-service-metadata: define the metadata of the service
// wind-service-protocols: define the protocols of the service
//
// Example Deployment:
/*
apiVersion: apps/v1
...
template:
  metadata:
    labels:
      app: nginx
      wind-service-id: "56991810-c77f-4a95-8190-393efa9c1a61"
      wind-service-app: "nginx"
      wind-service-version: "v3.5.0"
    annotations:
      wind-service-protocols: |
        {"80": "http"}
      wind-service-metadata: |
...
const (
	...
	AnnotationsKeyProtocolMap = "wind-service-protocols"
)
...
func (s *Registry) Register(ctx context.Context, service *wind.Instance) error {
	// GetMetadata
...
func (s *Registry) Deregister(ctx context.Context, _ *wind.Instance) error {
	return s.Register(ctx, &wind.Instance{
		Metadata: map[string]string{},
	})
}

// GetService return the service instances in memory according to the service name.
func (s *Registry) GetService(_ context.Context, name string) ([]*wind.Instance, error) {
	...
	ret := make([]*wind.Instance, 0, len(pods))
...
func (s *Registry) sendLatestInstances(ctx context.Context, name string, announcement chan []*wind.Instance) {
...
func (s *Registry) Watch(ctx context.Context, name string) (baseRegistry.Watcher, error) {
	...
	announcement := make(chan []*wind.Instance, 1)
...
// It reads the latest changes from the `chan []*wind.Instance`
...
func NewIterator(channel chan []*wind.Instance, stopCh chan struct{}) *Iterator {
	return &Iterator{
		ch:     channel,
		stopCh: stopCh,
	}
...
func (iter *Iterator) Next(ctx context.Context) ([]*wind.Instance, error) {
	select {
...
func getServiceInstanceFromPod(pod *corev1.Pod) (*wind.Instance, error) {
