...
func (c *Client) createApiClient() error {
	...
	if err != nil {
		windlog.GetLogger().Error(nil, "createApiClient", "error", err)
		return err
	}
...
func (c *Client) GetCheck(ctx context.Context, object, relation, subject string) (bool, error) {
	...
	data, response, err := c.fgaClient.OpenFgaApi.
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "GetCheck", "error", err, "response", response)
		return false, err
	}
...
func (c *Client) CreateStore(ctx context.Context, name string) error {
	store, response, err := c.fgaClient.OpenFgaApi.CreateStore(ctx).
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "CreateStore", "error", err, "response", response)
		return err
	}
...
func (c *Client) DeleteStore() error {
	...
	if err != nil {
		windlog.GetLogger().Error(nil, "DeleteStore", "error", err, "response", response)
		return err
	}
	return nil
}
...
func (c *Client) CreateRelationTuple(ctx context.Context, object, relation, subject string) error {
	...
	_, response, err := c.fgaClient.OpenFgaApi.
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "CreateRelationTuple", "error", err, "response", response)
		return err
	}
	return nil
}
...
func (c *Client) DeleteRelationTuple(ctx context.Context, object, relation, subject string) error {
	...
	_, response, err := c.fgaClient.OpenFgaApi.
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "DeleteRelationTuple", "error", err, "response", response)
		return err
	}
	return nil
}
...
func (c *Client) ExpandRelationTuple(ctx context.Context, object, relation string) error {
	...
	_, response, err := c.fgaClient.OpenFgaApi.
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "ExpandRelationTuple", "error", err, "response", response)
		return err
	}
	return nil
}
...
func (c *Client) CreateAuthorizationModel(ctx context.Context, writeAuthorizationModelRequestString string) (string, error) {
	...
	data, response, err := c.fgaClient.OpenFgaApi.
		...
		Execute()
	if err != nil {
		windlog.GetLogger().Error(ctx, "CreateAuthorizationModel", "error", err, "response", response)
		return "", err
	}
