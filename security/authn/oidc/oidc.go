...
func (a *Authenticator) Authenticate(requestContext context.Context) (*engine.AuthClaims, error) {
	tokenString, err := engine.AuthFromMD(requestContext, engine.BearerWord)
	if err != nil {
...
func (a *Authenticator) CreateIdentityWithContext(ctx context.Context, _ engine.AuthClaims) (context.Context, error) {
	return ctx, nil
}
